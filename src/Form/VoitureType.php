...
class VoitureType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('introduction', TextType::class, $this->getConfiguration("Introduction de l'annonce  /!\Requis/!\ ", "Ex: La Ferrari 328 remplace le Ferrari 308 en septembre 1985 au Salon automobile de Francfort...", ['attr' => ['class' => 'ckeditor']]))
            ->add('content', TextareaType::class, $this->getConfiguration("Contenue de l'annonce  /!\Requis/!\ ", "Ex: La Ferrari 328 remplace le Ferrari 308 en septembre 1985 au Salon automobile de Francfort. Les pare-chocs avant et arrière sont plus enveloppants et peints ton caisse et se dote d’un aileron arrière......", ['attr' => ['class' => 'ckeditor']]))
